...
DATASET_DIRS = [
    ...
    BASE_DIR / "section_b_xtts_dataset",
    BASE_DIR / "section_d_xtts_dataset",
]

OUT_DIR = BASE_DIR / "combined_abd_xtts_dataset"
...
(OUT_DIR / "dataset_summary.json").write_text(
    json.dumps(
        {
            "total_clips": len(df),
            "train_clips": len(df) - eval_size,
            "eval_clips": eval_size,
            "out_dir": str(OUT_DIR),
        },
        indent=2,
    ),
...
print(f"Expected total = 180 + 60 + 20 = 260")
